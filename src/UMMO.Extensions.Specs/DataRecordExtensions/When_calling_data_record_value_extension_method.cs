...
namespace UMMO.Extensions.Specs.DataRecordExtensions
{
    ...
    public class When_calling_data_record_value_extension_method
    {
        ...
        private Establish Context = () =>
                                        {
                                            ...
                                            _randomString = A.Random.String.ResemblingA.FirstName;
                                            _randomInt = A.Random.Integer.Value;
        ...
        private It Should_return_a_string_for_the_string_column
            = () => _dataRecordUnderTest.Value< string >( "string" ).ShouldBeOfExactType< string >();

        private It Should_return_an_date_for_the_date_column
            = () => _dataRecordUnderTest.Value< DateTime >( "date" ).ShouldBeOfExactType< DateTime >();

        private It Should_return_an_enum_for_the_enum_column
            = () => _dataRecordUnderTest.Value< TestEnum >( "enum" ).ShouldBeOfExactType< TestEnum >();

        private It Should_return_an_int_for_the_int_column
            = () => _dataRecordUnderTest.Value< int >( "int" ).ShouldBeOfExactType< int >();
